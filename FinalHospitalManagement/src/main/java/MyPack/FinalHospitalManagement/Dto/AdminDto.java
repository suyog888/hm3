...
public class AdminDto {
	...
	public AdminDto(int adminId, String firstName, String lastName, String username, String email, String phone,
	...
	public String toString() {
		return "AdminDto [adminId=" + adminId + ", firstName=" + firstName + ", lastName=" + lastName + ", username="
